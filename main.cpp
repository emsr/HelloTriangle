...
private:
                ...
                VkImage& image, VkDeviceMemory& imageMemory)
    {
        ...
        imageInfo.flags = 0; // Optional - could support sparse voxels.
    ...
    loadModel()
    {
        ...
        // Merge all the shapes into one global shape.
    ...
    {
        std::basic_ifstream<char> file(filename, std::ios::ate | std::ios::binary);
